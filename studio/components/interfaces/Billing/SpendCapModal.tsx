      ...
      <div className="py-4 space-y-4">
        <Modal.Content>
          <div className="space-y-4">
            <p className="text-sm">
              With the spend cap enabled, you cannot go above your plans included quota. While this
              gives you control over costs, it may restrict your service. Disabling the spend cap
              will then remove those limits and any additional resources consumed beyond the Pro
              tier limits will be charged on a per-usage basis
            </p>
            <p className="text-sm">
              The table below shows an overview of which resources are chargeable, and how they are
              charged:
            </p>
