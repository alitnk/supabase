              ...
              <div className="flex items-center justify-between gap-16 px-6 py-4 border rounded border-panel-border-light border-panel-border-dark bg-panel-body-light drop-shadow-sm dark:bg-panel-body-dark">
                <div>
                  ...
                  <p className="text-sm text-scale-1100">
                    Pro projects have the spend cap enabled by default to control your costs and
                    prevent your project from exceeding Pro limits. When enabled, usage will be
                    limited, and the project will experience restrictions when exhausting your
                    quota. To seamlessly scale beyond the Pro limits without restrictions, disable
                    the spend cap and you'll be charged for overusage beyond your quota.
                  </p>
                </div>
                <Toggle
