                    ...
                    <div className="p-1">
                      {subscriptionTier === PRICING_TIER_PRODUCT_IDS.FREE ? (
                        ...
                        <div className="space-y-4">
                          <p>
                            Your project is currently on the Pro tier with Spend Cap enabled. When
                            enabled, usage will be limited, and the project will experience
                            restrictions when passing limits. To seamlessly scale beyond the Pro
                            limits without restrictions, disable the spend cap and you'll be charged
                            for usage beyond your plan's quota.
                          </p>
